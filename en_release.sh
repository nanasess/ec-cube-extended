...
ECCUBE_VERSION=${ECCUBE_VERSION:-"2.12.6en-p1"}
WRK_DIR=eccube-$ECCUBE_VERSION
SVN_TAGS=$SVN_REPO/tags
#ECCUBE_VERSION=${ECCUBE_VERSION:-"2_12_3en-p2"}
...
svn export $SVN_TAGS/$WRK_DIR $WRK_DIR
...
mv $WRK_DIR/data/mtb_constants_init_en-US.php $WRK_DIR/data/mtb_constants_init.php
mv $WRK_DIR/html/install/sql/insert_data_en-US.sql $WRK_DIR/html/install/sql/insert_data.sql
mv $WRK_DIR/data/Smarty/templates/admin/pdf/nouhinsyo1_en-US.pdf $WRK_DIR/data/Smarty/templates/admin/pdf/nouhinsyo1.pdf
rm -f $WRK_DIR/html/install/save_image/nabe500.jpg
rm -f $WRK_DIR/html/install/save_image/ice130.jpg
rm -f $WRK_DIR/html/install/save_image/ice260.jpg
rm -f $WRK_DIR/html/install/save_image/ice500.jpg
rm -f $WRK_DIR/html/install/save_image/nabe130.jpg
rm -f $WRK_DIR/html/install/save_image/nabe260.jpg
rm -f $WRK_DIR/data/download/save/recipe_onabe.pdf
...
<parameters>
  <parameter name="Application Path"
             description="Application installation path（ex: Default Web Site/ec-cube.)"
