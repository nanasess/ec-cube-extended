        ...
        <div class="pay_area">
            ...
            <div class="btn_area">
                <ul>
                    ...
                    <li>
                      <input type="image" onclick="fnFormModeSubmit('form1', 'do_express', '', ''); return false;" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_next_on.jpg',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_next.jpg',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_next.jpg" alt="次へ" name="next" id="next" />
                    </li>
                </ul>
            </div>
        </div>
